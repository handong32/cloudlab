...
{    
    ...
    name="iter${ITER}"
    ssh $TBENCH_SERVER perf stat -a -e instructions,cycles,ref-cycles,power/energy-pkg/,cpu-clock -x, -o PerfStat.Overhead.$name ~/memcached/memcached -u nobody -t 40 -m 82G -c 8192 -o hashpower=20 -b 8192 -l $TBENCH_SERVER -B binary -L &
    sleep 1
...
function run
{
    ...
    ssh $TBENCH_SERVER perf stat -a -e instructions,cycles,ref-cycles,power/energy-pkg/,cpu-clock -x, -o PerfStat.$name ~/memcached/memcached -u nobody -t 40 -m 82G -c 8192 -o hashpower=20 -b 8192 -l $TBENCH_SERVER -B binary -L &
    sleep 1
